...
require 'cocoapods'
require 'cocoapods-tme-open-bin/native/podfile_env'
...
module Pod
  class Podfile
    ...
    def valid_bin_plugin
      unless plugins.keys.include?('cocoapods-tme-open-bin')
        raise Pod::Informative, 'You should add `plugin \'cocoapods-tme-open-bin\'` before using its DSL'
      end
    end
