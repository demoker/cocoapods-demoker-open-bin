...
require 'cocoapods-tme-open-bin/helpers/library_builder'
require 'cocoapods-tme-open-bin/helpers/build_helper'
require 'cocoapods-tme-open-bin/helpers/spec_source_creator'
require 'cocoapods-tme-open-bin/config/config_builder'
require 'cocoapods-tme-open-bin/command/bin/lib/lint'
