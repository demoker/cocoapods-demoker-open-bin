require 'cocoapods-tme-open-bin/native/sources_manager'
require 'cocoapods-tme-open-bin/command/bin/repo/update'
require 'cocoapods-tme-open-bin/config/config'
require 'cocoapods/user_interface'
require 'yaml'

Pod::HooksManager.register('cocoapods-tme-open-bin', :pre_install) do |_context, _|
  require 'cocoapods-tme-open-bin/native'
  require 'cocoapods-tme-open-bin/helpers/buildAll/bin_helper'
  ...
  if _context.podfile.plugins.keys.include?('cocoapods-tme-open-bin') && _context.podfile.configuration_env == 'dev'
...
Pod::HooksManager.register('cocoapods-tme-open-bin', :source_provider) do |context, _|
